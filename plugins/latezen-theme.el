...
(defvar latezen-colors-alist
  '(("latezen-fg+1"     . "#999999")
    ...
    ("latezen-red-3"    . "#ffdead")
    ("latezen-red-4"    . "#ffe4b5")
    ("latezen-orange"   . "#cdc0b0")
    ("latezen-yellow"   . "#cdc9a5")
    ("latezen-yellow-1" . "#f5fffa")
...
;;;;; font lock
   ...
   `(font-lock-string-face ((t (:foreground ,latezen-red))))
...
;;;;; auto-complete
   `(ac-candidate-face ((t (:background ,latezen-bg+3 :foreground ,latezen-bg-2))))
   `(ac-selection-face ((t (:background ,latezen-blue-4 :foreground ,latezen-fg))))
...
;;;;; diff
   `(diff-added ((,class (:foreground ,latezen-green+4 :background nil))
                 (t (:foreground ,latezen-green-1 :background nil))))
   `(diff-changed ((t (:foreground ,latezen-yellow))))
   `(diff-removed ((,class (:foreground ,latezen-red :background nil))
...
;;;;; org-mode
   ...
   `(org-done ((t (:bold t :weight bold :foreground ,latezen-green+3))))
   ...
   `(org-level-1 ((t (:foreground ,latezen-orange))))
   `(org-level-2 ((t (:foreground ,latezen-green+4))))
   `(org-level-3 ((t (:foreground ,latezen-blue-1))))
   ...
   `(org-table ((t (:foreground ,latezen-green+2))))
